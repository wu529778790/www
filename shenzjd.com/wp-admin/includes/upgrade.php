...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __( '欢迎使用WordPress优化版。这是您的第一篇文章。编辑或删除它，然后开始写作吧！' );
	}
	...
	// Default comment
	$first_comment_author = __('wordpress基地');
	$first_comment_url = 'http://wp8.me/';
	$first_comment = __('欢迎你使用wordpress优化版，么么哒！');
	if ( is_multisite() ) {
