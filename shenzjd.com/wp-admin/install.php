...
<body class="wp-core-ui">
	<p id="logo"><a href="#">WordPress优化版</a></p>
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	<table class="form-table">
		<tr>
			<th scope="row"><label for="weblog_title">站名：</label></th>
			<td><input name="weblog_title" type="text" id="weblog_title" size="25" value="<?php echo esc_attr( $weblog_title ); ?>" /></td>
		</tr>
		<tr>
			<th scope="row"><label for="user_login">帐号：</label></th>
			<td>
			<?php
			if ( $user_table ) {
		...
		<?php endif; ?>
		<tr>
			<th scope="row"><label for="admin_email">邮箱：</label></th>
			<td><input name="admin_email" type="email" id="admin_email" size="25" value="<?php echo esc_attr( $admin_email ); ?>" />
			</td>
		</tr>
		
	</table>
	<p class="step" style="margin: 30px 0 50px;"><?php submit_button( '安装', 'large', 'Submit', false, array( 'id' => 'submit' ) ); ?></p>
