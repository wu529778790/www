...
oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有查询到数据",sInfo:"显示 _START_ 到 _END_ 条，共 _TOTAL_ 条数据",sInfoEmpty:"显示 0 到 0 条，共 0 条数据",sInfoFiltered:"(从 _MAX_ 条数据中筛选结果)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"加载中...",sProcessing:"Processing...",sSearch:"快速搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到符合条件的记录"},oSearch:h.extend({},
