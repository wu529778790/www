...
<p id="nav">
<a href="<?php echo esc_url( wp_login_url() ); ?>" style="color:#999;"><?php _e('Log in') ?></a>
<?php
if ( get_option( 'users_can_register' ) ) :
	$registration_url = sprintf( '<a href="%s" style="color:#999;">%s</a>', esc_url( wp_registration_url() ), __( 'Register' ) );

	/** This filter is documented in wp-includes/general-template.php */
	echo ' | ' . apply_filters( 'register', $registration_url );
endif;
echo ' | <a href="/" style="color:#999;">首页</a>';
?>
</p>
...
<p id="nav">
<a href="<?php echo esc_url( wp_login_url() ); ?>" style="color:#999;"><?php _e( 'Log in' ); ?></a> |
<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" style="color:#999;"><?php _e( 'Lost your password?' ); ?></a> |
<a href="/" style="color:#999;">首页</a>
</p>
