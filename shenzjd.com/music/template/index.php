...
<head>
    ...
    <meta name="description" content="多站合一音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、5sing原创音乐、SoundCloud。">
...
<body>
        ...
        <div class="am-container">
            ...
            <nav class="am-collapse am-topbar-collapse am-fr" id="collapse-head">
                <ul class="am-nav am-nav-pills am-topbar-nav">
                    <li class="am-active">
                        <a href="//newbug.xyz/music">音乐搜索器</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <footer class="footer">
        <p class="am-text-sm"> &copy; 2013-<?php echo date('Y', time()); ?> <a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">版权声明</a></p>
    </footer>
